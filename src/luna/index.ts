    ...
    return this.#invokeStructured(
      ...
      governanceOutputJsonSchema,
      {
        ...
        rules: [
          ...
          "Age, zero retrieval, or low model importance alone never authorizes archival. Archive only when supplied evidence establishes semantic obsolescence, transient or invalid content, or an explicitly reviewed successor.",
          "Preserve durable workflows, failure and recovery knowledge, constraints, negations, safety rules, architecture and API contracts, and expensive-to-rediscover knowledge even when they were not recently selected.",
